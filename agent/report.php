...
echo "						<td width=\"10%\" height=\"20\" align=\"center\"><b>未拆帳金額</b></td>\n";
...
if ( mysqli_num_rows($QUERY_Agent) )
{
    ...
    while ($LIST_Agent = mysqli_fetch_assoc($QUERY_Agent))
    {
		...
		// 二維陣列 ->
		// BetGodnine_Money : 投注金額 , BetGodnine_Online_WinLost_Money : 總金額 , BetGodnine_Online_Backwater_Money : 會員返水
		// BetGodnine_Online_AllMoney : 輸贏金額 , BetGodnine_Online_Reported_Money : 報帳金額
		...
		if( 1 )
		{
				$Count_BetGodnine = func_DatabaseGet( $tmp_SQL_BetGodnine , "COUNT" , "" ) ;		// 取得資料庫資料
				$tmp_Max_BetGodnine = 30000 ;
				$tmp_Page = (int)($Count_BetGodnine / $tmp_Max_BetGodnine) ;
				//echo "資料個數 : $Count_BetGodnine , 頁數 : $tmp_Page<br>" ;
		
				unset($array_BetGodnineMoney);
				...
				{// unset()
					$tmp_Start_Index = $i * $tmp_Max_BetGodnine ;
					$tmp_SQL_Index = $tmp_SQL_BetGodnine . " LIMIT $tmp_Start_Index , $tmp_Max_BetGodnine" ;
					//echo "<p>$i - Index SQL : $tmp_SQL_Index</p>" ;
					
					$array_BetGodnineMoney_Index = GodNine_getBetGodnineMoney( $tmp_SQL_Index , $LIST_Agent['id_Agent'] ) ;		// 取得下注相關金額
					//echo "<p>回傳資料</p>" ;print_r($array_BetGodnineMoney_Index);echo "<br>" ;
		
					$array_BetGodnineMoney['BetGodnine_Num'] += $array_BetGodnineMoney_Index['BetGodnine_Num'] ;					// 有下注筆數
					
					// 設定值
					$array_BetGodnineMoney[1]['BetGodnine_Money'] += $array_BetGodnineMoney_Index[1]['BetGodnine_Money'] ;					// 投注金額
					$array_BetGodnineMoney[1]['BetGodnine_Online_Backwater_Money'] += $array_BetGodnineMoney_Index[1]['BetGodnine_Online_Backwater_Money'] ;	// 會員返水
					$array_BetGodnineMoney[1]['BetGodnine_Online_WinLost_Money'] += $array_BetGodnineMoney_Index[1]['BetGodnine_Online_WinLost_Money'] ;		// 總金額
					$array_BetGodnineMoney[1]['BetGodnine_Online_AllMoney'] += $array_BetGodnineMoney_Index[1]['BetGodnine_Online_AllMoney'] ;			// 輸贏金額
					$array_BetGodnineMoney[1]['BetGodnine_Online_Reported_Money'] += $array_BetGodnineMoney_Index[1]['BetGodnine_Online_Reported_Money'] ;	// 報帳金額
		
					$array_BetGodnineMoney[2]['BetGodnine_Money'] += $array_BetGodnineMoney_Index[2]['BetGodnine_Money'] ;					// 投注金額
					$array_BetGodnineMoney[2]['BetGodnine_Online_Backwater_Money'] += $array_BetGodnineMoney_Index[2]['BetGodnine_Online_Backwater_Money'] ;	// 會員返水
					$array_BetGodnineMoney[2]['BetGodnine_Online_WinLost_Money'] += $array_BetGodnineMoney_Index[2]['BetGodnine_Online_WinLost_Money'] ;		// 總金額
					$array_BetGodnineMoney[2]['BetGodnine_Online_AllMoney'] += $array_BetGodnineMoney_Index[2]['BetGodnine_Online_AllMoney'] ;			// 輸贏金額
					$array_BetGodnineMoney[2]['BetGodnine_Online_Reported_Money'] += $array_BetGodnineMoney_Index[2]['BetGodnine_Online_Reported_Money'] ;	// 報帳金額

                    $array_BetGodnineMoney[3]['BetGodnine_Money'] += $array_BetGodnineMoney_Index[3]['BetGodnine_Money'] ;					// 投注金額
                    $array_BetGodnineMoney[3]['BetGodnine_Online_Backwater_Money'] += $array_BetGodnineMoney_Index[3]['BetGodnine_Online_Backwater_Money'] ;	// 會員返水
                    $array_BetGodnineMoney[3]['BetGodnine_Online_WinLost_Money'] += $array_BetGodnineMoney_Index[3]['BetGodnine_Online_WinLost_Money'] ;		// 總金額
                    $array_BetGodnineMoney[3]['BetGodnine_Online_AllMoney'] += $array_BetGodnineMoney_Index[3]['BetGodnine_Online_AllMoney'] ;			// 輸贏金額
                    $array_BetGodnineMoney[3]['BetGodnine_Online_Reported_Money'] += $array_BetGodnineMoney_Index[3]['BetGodnine_Online_Reported_Money'] ;	// 報帳金額
				}
		
				//echo "<p>統計資料</p>" ;print_r($array_BetGodnineMoney);echo "<br>" ;
		}
		else
		{
        ...
        // 取得所有閒家上線代理人資料
        //$array_AgentList = GodNine_getAgentList( $LIST_Agent['id_Agent'] , "A" , "3" ) ;		// 取得所有上線代理人資料
        //print_r($array_AgentList);
        ...
        // 合計-長莊區有倍率區
        // 投注金額
        $sum_BetGodnine_Money += $array_BetGodnineMoney[3]['BetGodnine_Money'] ;
        // 輸贏金額
        $sum_BetGodnine_Online_WinLost_Money += $array_BetGodnineMoney[3]['BetGodnine_Online_WinLost_Money'] ;
        // 會員返水
        $sum_BetGodnine_Online_Backwater_Money += $array_BetGodnineMoney[3]['BetGodnine_Online_Backwater_Money'] ;
        // 總金額
        $sum_BetGodnine_Online_AllMoney += $array_BetGodnineMoney[3]['BetGodnine_Online_AllMoney'] ;
        // 報帳金額
        $sum_BetGodnine_Online_Reported_Money += $array_BetGodnineMoney[3]['BetGodnine_Online_Reported_Money'] ;
