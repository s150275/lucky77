...
// 公告狀態 0||下架||1||上架:
$array_Bulletin_On[0] = "下架" ;
$array_Bulletin_On[1] = "上架" ;
...
function showForm( $LIST , $subFUNCT )
{
	...
	echo "<input type='hidden' name='ID' value='{$LIST['id_Bulletin']}'>\n" ;
	echo "	<tr>\n";
	echo "		<td colspan=2 style=\"padding-left:10px\">\n";
	echo "			<table width=\"99%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"table_list\">\n";
	echo "				<tr>\n";
	echo "					<td width=10% align=\"center\"><b>公告標題</b></td>\n";
	echo "					<td width=90% align=\"left\"><input type='text' name='Bulletin_Title' value='{$LIST['Bulletin_Title']}' style='width:100%;'></td>\n";
	echo "				</tr>\n";
	echo "				<tr>\n";
	echo "					<td width=10% align=\"center\"><b>公告內容</b></td>\n";
	//echo "					<td width=90% align=\"left\"><input type='text' name='Bulletin_Content' value='{$LIST['Bulletin_Content']}' style='width:100%;'></td>\n";
	echo "					<td width=90% align=\"left\"><textarea name='Bulletin_Content' rows=10 style='width:100%;'>{$LIST['Bulletin_Content']}</textarea></td>\n";
	echo "				</tr>\n";
	echo "				<tr>\n";
	echo "					<td width=10% align=\"center\"><b>公告狀態</b></td>\n";
	echo "					<td width=90% align=\"left\"><input type='radio' name='Bulletin_On' value='1' " . checksCheckBox($LIST['Bulletin_On'] , 1) . ">上架 <input type='radio' name='Bulletin_On' value='0' " . checksCheckBox($LIST['Bulletin_On'] , 0) . ">下架</td>\n";
	echo "				</tr>\n";
	echo "				<tr>\n";
...
echo "					<td width=\"99%\" align=\"left\" class=\"blue_text\">首頁 &gt; 前台系統公告 </td>\n";
echo "				</tr>\n";
echo "				<tr>\n";
...
echo "						<a href=\"Bulletin.php?Funct=ADD\"><img border=\"0\" src=\"images/add_icon.gif\" align=\"absmiddle\" style=\"padding-right:5px\">新增系統公告</a>\n";
echo "					</td>\n";
...
else
{
	...
	echo "					<td width=20% height=\"20\" align=\"center\"><b>日期</b></td>\n";
	echo "					<td width=60% height=\"20\" align=\"center\"><b>公告標題</b></td>\n";
	...
	// 找出人資料
	$countSQL = "SELECT * FROM Bulletin ORDER BY Bulletin_On DESC , Bulletin_Mod_DT DESC" ;
	//echo $countSQL . "<br>" ; 
	...
	$SQL_Bulletin = $countSQL . " LIMIT $start , $row";
	...
	if ( mysqli_num_rows($QUERY_Bulletin) )
	{
		...
		while ($LIST_Bulletin = mysqli_fetch_assoc($QUERY_Bulletin))
		{
			...
			echo "					<td height=\"25\" align=\"center\">{$LIST_Bulletin['Bulletin_Add_DT']}</td>\n";
			echo "					<td align=\"left\"><a href=\"Bulletin.php?ID={$LIST_Bulletin['id_Bulletin']}&Funct=MOD\">{$LIST_Bulletin['Bulletin_Title']}</a></td>\n";
			echo "					<td align=\"center\">{$array_Bulletin_On[$LIST_Bulletin['Bulletin_On']]}</td>\n";
			echo "					<td align=\"center\">\n";
			//echo "						<a href=\"Bulletin.php?ID={$LIST_Bulletin['id_Bulletin']}&Funct=MOD\">修改</a>\n";
			echo "						<a class='BTN-SaveData' data-type='刪除' data-id='{$LIST_Bulletin['id_Bulletin']}'>刪除</a>\n";
			echo "					</td>\n";
			echo "				</tr>\n";
			$tmp_Index++ ;
		}
