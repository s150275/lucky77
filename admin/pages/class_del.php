...
if($_POST['c_id']!='' && $_POST['delete']=='yes')
{
	$c_id        =  trim($_POST['c_id']);
	$DELETESQL="DELETE FROM proclass WHERE c_id='$c_id'";
            ...
            <div class="row">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
					<form action="class_del.php" method="post" id="insertform" name="insertform" role="form">
                        <div class="form-group">
                            <label>名稱</label>
                            <input name="n_subject" disabled class="form-control" id="n_subject" value="<?php echo $data["c_name"]?>">
                        </div>
