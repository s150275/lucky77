...
$MAIN_PROGRAM_TITLE	= "取得操作記錄" ;			// 設定程式的TITLE文字
$MAIN_BASE_ADDRESS	= "" ;				// 設定檔案和首頁的相對位置
$MAIN_FILE_NAME_ADDRESS	= "" ;		// 設定本程式所在的路徑
$MAIN_DATABASE_NAME	= "" ;				// 設定本程式所使用的基本資料庫
$MAIN_FILE_NAME		= "reportLogA_htmlOperationRecordList.php" ;			// 設定本程式的檔名
...
//echo "查詢功能 : $Funct , 查詢字串 : $Para" ;
GodNine_htmlOperationRecordList( $Funct , $Para ) ;		// 取得開獎記錄
