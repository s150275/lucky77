...
//$Old_BetGodnine_Bingo_Period = $LIST['BetGodnine_Bingo_Period'] ;
			...
			{// 莊家贏
				...
				// 莊家輸贏總金額(莊家贏)
				if( $LIST['BetGodnine_Type'] == 2 OR $LIST['BetGodnine_Type'] == 3 )// 長莊區 有倍與無倍 = 莊家輸贏金額 * (100-佔成)/100
				...
				// 會員下注總金額(閒家輸)
				if( $LIST['BetGodnine_Type'] == 2 OR $LIST['BetGodnine_Type'] == 3 )// 長莊區 = 會員下注輸贏金額 * (100-會員下注占成)/100
				...
				// 莊家輸贏總金額(莊家贏)
				if( $LIST['BetGodnine_Type'] == 2 OR $LIST['BetGodnine_Type'] == 3 )// 長莊區 = 莊家輸贏金額 * (100-會員下注占成)/100
			...
			{// 閒家贏
				...
				// 莊家--------------------------------------------------
				// 莊家輸贏總金額(莊家輸)
				if( $LIST['BetGodnine_Type'] == 2 OR $LIST['BetGodnine_Type'] == 3 )// 長莊區 = 莊家輸贏金額 * (100-佔成)/100
				{
					$tmp_Banker_WinLost_AllMoney = $tmp_Banker_WinLost_Money * ( 100 - $tmp_Banker_Proportion ) / 100 ;
			...
			foreach( $array_AgentList["I"] as $key => $value )
			{
				...
				// 上線總金額
				if( $LIST['BetGodnine_Type'] == 2 OR $LIST['BetGodnine_Type'] == 3 )// 長莊區 = 上線輸贏金額 * (100-佔比)/100
			...
			else
			{
				...
				else
				{
					...
					for($i=0;$i<count($array_BankerList_Info['Banker_Info']);$i++)
					{
						...
						/*if($array_BankerList_Info['Next_Banker_Seat']=="39,40")
						{
							$tmp_htmlBankerArea .= "							<p id='N' class='BankerInfo'>系統(T桌)</p>\n";
						}*/
					}
				}
