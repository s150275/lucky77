...
echo "			<a class=\"list_link\" href=\"room.php?zone_code=1\"><span class=\"list_text\">輪莊有倍數區</span></a>\n";
echo "		</li>\n";
echo "		<li class=\"list_item\">\n";
echo "			<a class=\"list_link\" href=\"room.php?zone_code=2\"><span class=\"list_text\">長莊無倍數區</span></a>\n";
echo "		</li>\n";
echo "		</ul>\n";
echo "	</div>\n";
