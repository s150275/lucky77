...
if ( mysqli_num_rows($QUERY) )
{
    ...
    while ($LIST = mysqli_fetch_assoc($QUERY))
    {
		...
		echo "				</td>\n";
		echo "				<td>\n";
		echo "				<span>閒:{$LIST['BetGodnine_Table']}桌 / {$array_Bingo_Draw_Order_Num[$LIST['BetGodnine_Table']-1]} 、{$array_Bingo_Godnine_Calculate[$LIST['BetGodnine_Table']-1]} / ({$array_Bingo_Godnine_Multiple[$LIST['BetGodnine_Table']-1]})</span><br>\n";
		...
		{	echo "				<span>莊:20桌 / {$array_Bingo_Draw_Order_Num[19]} 、 {$array_Bingo_Godnine_Calculate[19]} / (1) </span>\n";	}
