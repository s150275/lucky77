...
$array_Bingo_Info = func_DatabaseGet( "Bingo" , "*" , array("Bingo_Period"=>$array_BingoPeriod['LastBingo']) ) ;		// 取得資料庫資料


echo $array_Bingo_Info['Bingo_Draw_Order_Num'] ;
